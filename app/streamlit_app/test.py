...
download_foler = "streamlit_app/outputs"
...
if 'files' not in st.session_state:
    st.session_state.files = [i[:-5] for i in list(os.listdir("actions/form_feilds_mapping_v2"))]
if 'forms' not in st.session_state:
    st.session_state.forms = json.load(open("actions/form_filling_code/forms_subset.json"))
